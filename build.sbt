...
lazy val root = Project("gatling-parent", file("."))
  ...
  .aggregate(nettyUtil, commons, core, jdbc, redis, httpClient, http, jms, charts, graphite, datadog, app, recorder, testFramework, bundle, compiler)
...
lazy val app = gatlingModule("gatling-app")
  .dependsOn(core, http, jms, jdbc, redis, graphite, datadog, charts)
