...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.38.Final"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "7.0.1")
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.3.0-M8")
  ...
  private val bouncyCastle                   = "org.bouncycastle"                     % "bcpkix-jdk15on"                  % "1.62"
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.19.v20190610"  % "test"
